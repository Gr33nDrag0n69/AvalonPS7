...
.SYNOPSIS
    ...
    Enable a mining pool on an Avalon miner.
...
.EXAMPLE
    ...
    PS> .\Enable-AvalonMinerPool.ps1 -MinerIP 192.168.0.236 -PoolID 1
...
$ApiObject = Invoke-AvalonAPI -IP $MinerIP -Command 'enablepool' -Params "$PoolID"
