...
.EXAMPLE
    ...
    PS> .\Restart-AvalonMiner.ps1 -MinerIP 192.168.0.236

.EXAMPLE

    Reboot with 10 second delay:

    PS> .\Restart-AvalonMiner.ps1 -MinerIP 192.168.0.236 -DelaySeconds 10
...
$ApiObject = Invoke-AvalonAPI -IP $MinerIP -Command 'ascset' -Params "0,reboot,$DelaySeconds"
