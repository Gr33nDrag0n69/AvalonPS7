...
.EXAMPLE
    ...
    PS> .\Set-AvalonMinerActivePool.ps1 -MinerIP 192.168.0.236 -PoolID 1
...
$ApiObject = Invoke-AvalonAPI -IP $MinerIP -Command 'switchpool' -Params "$PoolID"
